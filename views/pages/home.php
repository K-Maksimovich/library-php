...
$res_clients = mysqli_query( App::$connect, "SELECT COUNT(*) FROM `clients`");
...
<main class="main">
    ...
    <div class="block-view">
        ...
        <div id="line"></div>
        <div class="title">
            <p id="title">Manage authors, books and clients in this web application.</p>
        </div>
    </div>
    ...
    <div class="row container" id="card-list">
        <div class="col-sm" id="c1">
            ...
            <a href="/backend/library/authors" class="btn btn-outline-secondary but" id="input-group-button-left">View all</a>
        </div>
        <div class="col-sm" id="c2">
            <p class="one"><?= $res_books ?> books</p>
            <p class="two">Classic, science and fantastic</p>
            <a href="/backend/library/books" class="btn btn-outline-secondary but" id="input-group-button-left">View all</a>
        </div>
        <div class="col-sm" id="c3">
            <p class="one"><?= $res_clients ?> clients</p>
            <p class="two">People are interested in reading</p>
            <a href="/backend/library/clients" class="btn btn-outline-secondary but" id="input-group-button-left">View all</a>
        </div>
    </div>
